$(document).ready(function() {
    ...
    $(document).on('click', '#btnRemoveItem', function() {
        ...
        // if (job_no == undefined || job_no == '') {
        //     link = "../../item_remove/" + id;
        //     href = "../item_list/" + job_no;
        // } else {
        //     link = "../item_remove/" + id + "/" + job_no;
        //     href = "../item_list/" + job_no;
        // }
                    ...
                    .then(function(data) {
                        if (data == 'success') {
                            ...
                            swal({
                                ...
                                if (result.value) {
                                    window.location.href = '../item_list/' + job_no;
                                }
                            });
                        } else {
    ...
    $(document).on('click', '#btnRemoveScrapItem', function() {

        var id = $(this).attr('data-id');
        var job_no = $(this).attr('data-jobno');
        var test_no = $(this).attr('data-testno');
                    ...
                    .then(function(data) {
                        if (data == 'success') {
                            ...
                            swal({
                                ...
                                if (result.value) {
                                    window.location.href = '../' + job_no + '/' + test_no;
                                }
                            });
                        } else {
                            //$("#tblItemList").find("button[data-id='" + id + "']").closest("tr").remove();
    ...
    $(document).on('click', '#btnAddScrapItem', function() {
        ...
        swal({
            title: 'Add a new Scrap Item',
            html: '' +
                '<input id="swal-input1" class="swal2-input" autofocus placeholder="Description">' +
                '<input id="swal-input2" class="swal2-input int" placeholder="Quantity">',
            preConfirm: function() {
            ...
            s_desc = result['value'][0];
            quantity = result['value'][1];


            if (s_desc == '' || s_desc == undefined) {
                swal(
                    'Invalid',
            ...
            return $.get("../../add_item/" + job_no + "/" + test_no + "/" + s_desc + "/" + quantity).then(function(data) {
                if (data == 'success') {
    ...
    $(document).on('click', '#btnUndoReceive', function() {
        ...
        swal({
            ...
            if (result.value) {
                return $.get("./receiving/delete/" + id)
                    .then(function(data) {
                        if (data == 'success') {

                            swal({
                                title: 'Deleted!',
                                text: 'Undo received successful.',
                                type: 'success',
                                allowOutsideClick: false,
                            }).then(function(result) {
                                if (result.value) {
    ...
    $(document).on('click', '#btnDeleteAnnoucement', function() {
        ...
        swal({
            ...
            if (result.value) {
                return $.get("./announcements/delete/" + id)
                    .then(function(data) {
                        if (data == 'success') {
                            ...
                            swal({
                                title: 'Deleted!',
                                text: 'Announcement has been succesfully deleted.',
                                type: 'success',
                                allowOutsideClick: false,
                            }).then(function(result) {
                                if (result.value) {
